// Case-folding function for Unicode 15.0.0 (released on 2022-02-02)
// Generated by scripts/mapgen.py on 2022-11-21
...
pub fn lookup(orig: char) -> Fold {
    ...
    if from <= 0x2CFF {
        ...
        let single_char: u16 = match high_byte {
            0x00 => match low_byte {
                x if (0x41..=0x5a).contains(&x) => from.wrapping_add(0x0020),
                0xb5 => 0x03bc,
                x if (0xc0..=0xd6).contains(&x) => from.wrapping_add(0x0020),
                x if (0xd8..=0xde).contains(&x) => from.wrapping_add(0x0020),
                0xdf => return Fold::Two('\u{0073}', '\u{0073}'),
                _ => from,
            },
            0x01 => match low_byte {
                x if (0x00..=0x2e).contains(&x) => from | 1,
                0x30 => return Fold::Two('\u{0069}', '\u{0307}'),
                x if (0x32..=0x36).contains(&x) => from | 1,
                x if (0x39..=0x47).contains(&x) => (from + 1) & !1,
                0x49 => return Fold::Two('\u{02bc}', '\u{006e}'),
                x if (0x4a..=0x76).contains(&x) => from | 1,
                0x78 => 0x00ff,
                x if (0x79..=0x7d).contains(&x) => (from + 1) & !1,
                0x7f => 0x0073,
                0x81 => 0x0253,
                x if (0x82..=0x84).contains(&x) => from | 1,
                0x86 => 0x0254,
                0x87 => 0x0188,
                x if (0x89..=0x8a).contains(&x) => from.wrapping_add(0x00cd),
                0x8b => 0x018c,
                0x8e => 0x01dd,
                0x8f => 0x0259,
                0x90 => 0x025b,
                ...
                0x9d => 0x0272,
                0x9f => 0x0275,
                x if (0xa0..=0xa4).contains(&x) => from | 1,
                0xa6 => 0x0280,
                0xa7 => 0x01a8,
                0xa9 => 0x0283,
                0xac => 0x01ad,
                0xae => 0x0288,
                0xaf => 0x01b0,
                x if (0xb1..=0xb2).contains(&x) => from.wrapping_add(0x00d9),
                x if (0xb3..=0xb5).contains(&x) => (from + 1) & !1,
                0xb7 => 0x0292,
                0xb8 => 0x01b9,
                0xbc => 0x01bd,
                0xc4 => 0x01c6,
                ...
                0xc8 => 0x01c9,
                0xca => 0x01cc,
                x if (0xcb..=0xdb).contains(&x) => (from + 1) & !1,
                x if (0xde..=0xee).contains(&x) => from | 1,
                0xf0 => return Fold::Two('\u{006a}', '\u{030c}'),
                0xf1 => 0x01f3,
                x if (0xf2..=0xf4).contains(&x) => from | 1,
                0xf6 => 0x0195,
                0xf7 => 0x01bf,
                x if (0xf8..=0xff).contains(&x) => from | 1,
                _ => from,
            },
            0x02 => match low_byte {
                x if (0x00..=0x1e).contains(&x) => from | 1,
                0x20 => 0x019e,
                x if (0x22..=0x32).contains(&x) => from | 1,
                0x3a => 0x2c65,
                0x3b => 0x023c,
                0x3d => 0x019a,
                0x3e => 0x2c66,
                ...
                0x44 => 0x0289,
                0x45 => 0x028c,
                x if (0x46..=0x4e).contains(&x) => from | 1,
                _ => from,
            },
            0x03 => match low_byte {
                0x45 => 0x03b9,
                x if (0x70..=0x72).contains(&x) => from | 1,
                0x76 => 0x0377,
                0x7f => 0x03f3,
                0x86 => 0x03ac,
                x if (0x88..=0x8a).contains(&x) => from.wrapping_add(0x0025),
                0x8c => 0x03cc,
                x if (0x8e..=0x8f).contains(&x) => from.wrapping_add(0x003f),
                0x90 => return Fold::Three('\u{03b9}', '\u{0308}', '\u{0301}'),
                x if (0x91..=0xa1).contains(&x) => from.wrapping_add(0x0020),
                x if (0xa3..=0xab).contains(&x) => from.wrapping_add(0x0020),
                ...
                0xd5 => 0x03c6,
                0xd6 => 0x03c0,
                x if (0xd8..=0xee).contains(&x) => from | 1,
                0xf0 => 0x03ba,
                0xf1 => 0x03c1,
                0xf4 => 0x03b8,
                0xf5 => 0x03b5,
                ...
                0xf9 => 0x03f2,
                0xfa => 0x03fb,
                x if (0xfd..=0xff).contains(&x) => from.wrapping_sub(0x0082),
                _ => from,
            },
            0x04 => match low_byte {
                x if (0x00..=0x0f).contains(&x) => from.wrapping_add(0x0050),
                x if (0x10..=0x2f).contains(&x) => from.wrapping_add(0x0020),
                x if (0x60..=0x80).contains(&x) => from | 1,
                x if (0x8a..=0xbe).contains(&x) => from | 1,
                0xc0 => 0x04cf,
                x if (0xc1..=0xcd).contains(&x) => (from + 1) & !1,
                x if (0xd0..=0xff).contains(&x) => from | 1,
                _ => from,
            },
            0x05 => match low_byte {
                x if (0x00..=0x2e).contains(&x) => from | 1,
                x if (0x31..=0x56).contains(&x) => from.wrapping_add(0x0030),
            ...
            0x0f => from,
            0x10 => match low_byte {
                x if (0xa0..=0xc5).contains(&x) => from.wrapping_add(0x1c60),
                0xc7 => 0x2d27,
                0xcd => 0x2d2d,
                _ => from,
            },
            ...
            0x12 => from,
            0x13 => match low_byte {
                x if (0xf8..=0xfd).contains(&x) => from.wrapping_sub(0x0008),
                _ => from,
            },
            0x14 => from,
            0x15 => from,
            ...
            0x1c => match low_byte {
                ...
                0x81 => 0x0434,
                0x82 => 0x043e,
                x if (0x83..=0x84).contains(&x) => from.wrapping_sub(0x1842),
                0x85 => 0x0442,
                0x86 => 0x044a,
                0x87 => 0x0463,
                0x88 => 0xa64b,
                x if (0x90..=0xba).contains(&x) => from.wrapping_sub(0x0bc0),
                x if (0xbd..=0xbf).contains(&x) => from.wrapping_sub(0x0bc0),
                _ => from,
            },
            0x1d => from,
            0x1e => match low_byte {
                x if (0x00..=0x94).contains(&x) => from | 1,
                ...
                x if (0xa0..=0xfe).contains(&x) => from | 1,
                _ => from,
            },
            0x1f => match low_byte {
                x if (0x08..=0x0f).contains(&x) => from.wrapping_sub(0x0008),
                x if (0x18..=0x1d).contains(&x) => from.wrapping_sub(0x0008),
                x if (0x28..=0x2f).contains(&x) => from.wrapping_sub(0x0008),
                x if (0x38..=0x3f).contains(&x) => from.wrapping_sub(0x0008),
                x if (0x48..=0x4d).contains(&x) => from.wrapping_sub(0x0008),
                ...
                x if (0x68..=0x6f).contains(&x) => from.wrapping_sub(0x0008),
                ...
                x if (0xb8..=0xb9).contains(&x) => from.wrapping_sub(0x0008),
                x if (0xba..=0xbb).contains(&x) => from.wrapping_sub(0x004a),
                ...
                x if (0xc8..=0xcb).contains(&x) => from.wrapping_sub(0x0056),
                ...
                x if (0xd8..=0xd9).contains(&x) => from.wrapping_sub(0x0008),
                x if (0xda..=0xdb).contains(&x) => from.wrapping_sub(0x0064),
                ...
                x if (0xe8..=0xe9).contains(&x) => from.wrapping_sub(0x0008),
                x if (0xea..=0xeb).contains(&x) => from.wrapping_sub(0x0070),
                0xec => 0x1fe5,
                ...
                x if (0xf8..=0xf9).contains(&x) => from.wrapping_sub(0x0080),
                x if (0xfa..=0xfb).contains(&x) => from.wrapping_sub(0x007e),
            ...
            0x21 => match low_byte {
                ...
                0x2b => 0x00e5,
                0x32 => 0x214e,
                x if (0x60..=0x6f).contains(&x) => from.wrapping_add(0x0010),
                0x83 => 0x2184,
                _ => from,
            },
            0x22 => from,
            0x23 => from,
            0x24 => match low_byte {
                x if (0xb6..=0xcf).contains(&x) => from.wrapping_add(0x001a),
                _ => from,
            },
            0x25 => from,
            0x26 => from,
            ...
            0x2b => from,
            0x2c => match low_byte {
                x if (0x00..=0x2f).contains(&x) => from.wrapping_add(0x0030),
                0x60 => 0x2c61,
                0x62 => 0x026b,
                0x63 => 0x1d7d,
                0x64 => 0x027d,
                x if (0x67..=0x6b).contains(&x) => (from + 1) & !1,
                0x6d => 0x0251,
                0x6e => 0x0271,
                0x6f => 0x0250,
                0x70 => 0x0252,
                0x72 => 0x2c73,
                0x75 => 0x2c76,
                x if (0x7e..=0x7f).contains(&x) => from.wrapping_sub(0x2a3f),
                x if (0x80..=0xe2).contains(&x) => from | 1,
                x if (0xeb..=0xed).contains(&x) => (from + 1) & !1,
                0xf2 => 0x2cf3,
                _ => from,
            },
            _ => from,
        ...
        let single_char: u32 = match from {
            x if (0xa640..=0xa66c).contains(&x) => from | 1,
            x if (0xa680..=0xa69a).contains(&x) => from | 1,
            x if (0xa722..=0xa72e).contains(&x) => from | 1,
            x if (0xa732..=0xa76e).contains(&x) => from | 1,
            x if (0xa779..=0xa77b).contains(&x) => (from + 1) & !1,
            0xa77d => 0x1d79,
            x if (0xa77e..=0xa786).contains(&x) => from | 1,
            0xa78b => 0xa78c,
            0xa78d => 0x0265,
            x if (0xa790..=0xa792).contains(&x) => from | 1,
            x if (0xa796..=0xa7a8).contains(&x) => from | 1,
            0xa7aa => 0x0266,
            0xa7ab => 0x025c,
            0xa7ac => 0x0261,
            0xa7ad => 0x026c,
            ...
            0xa7b2 => 0x029d,
            0xa7b3 => 0xab53,
            x if (0xa7b4..=0xa7c2).contains(&x) => from | 1,
            0xa7c4 => 0xa794,
            0xa7c5 => 0x0282,
            0xa7c6 => 0x1d8e,
            x if (0xa7c7..=0xa7c9).contains(&x) => (from + 1) & !1,
            0xa7d0 => 0xa7d1,
            x if (0xa7d6..=0xa7d8).contains(&x) => from | 1,
            0xa7f5 => 0xa7f6,
            x if (0xab70..=0xabbf).contains(&x) => from.wrapping_sub(0x97d0),
            ...
            x if (0xff21..=0xff3a).contains(&x) => from.wrapping_add(0x0020),
            x if (0x10400..=0x10427).contains(&x) => from.wrapping_add(0x0028),
            x if (0x104b0..=0x104d3).contains(&x) => from.wrapping_add(0x0028),
            x if (0x10570..=0x1057a).contains(&x) => from.wrapping_add(0x0027),
            x if (0x1057c..=0x1058a).contains(&x) => from.wrapping_add(0x0027),
            x if (0x1058c..=0x10592).contains(&x) => from.wrapping_add(0x0027),
            x if (0x10594..=0x10595).contains(&x) => from.wrapping_add(0x0027),
            x if (0x10c80..=0x10cb2).contains(&x) => from.wrapping_add(0x0040),
            x if (0x118a0..=0x118bf).contains(&x) => from.wrapping_add(0x0020),
            x if (0x16e40..=0x16e5f).contains(&x) => from.wrapping_add(0x0020),
            x if (0x1e900..=0x1e921).contains(&x) => from.wrapping_add(0x0022),
            _ => from,
        };
