...
pub fn lookup(orig: char) -> Fold {
    ...
    if from <= 0x2CFF {
        ...
        let single_char: u16 = match high_byte {
            0x00 => {
                match low_byte {
                    0x41 ..= 0x5a  => from.wrapping_add(0x0020),
                    0xb5 => 0x03bc,
                    0xc0 ..= 0xd6  => from.wrapping_add(0x0020),
                    0xd8 ..= 0xde  => from.wrapping_add(0x0020),
            ...
            0x01 => {
                match low_byte {
                    ...
                    0x86 => 0x0254,
                    0x87 => 0x0188,
                    0x89 ..= 0x8a  => from.wrapping_add(0x00cd),
                    0x8b => 0x018c,
                    0x8e => 0x01dd,
                    0x8f => 0x0259,
                    0x90 => 0x025b,
                    ...
                    0xae => 0x0288,
                    0xaf => 0x01b0,
                    0xb1 ..= 0xb2  => from.wrapping_add(0x00d9),
                    0xb3 ..= 0xb5  => ((from+1) & !1),
                    0xb7 => 0x0292,
                    0xb8 => 0x01b9,
                    0xbc => 0x01bd,
            ...
            0x03 => {
                match low_byte {
                    ...
                    0x7f => 0x03f3,
                    0x86 => 0x03ac,
                    0x88 ..= 0x8a  => from.wrapping_add(0x0025),
                    0x8c => 0x03cc,
                    0x8e ..= 0x8f  => from.wrapping_add(0x003f),
                    0x90 => return Fold::Three('\u{03b9}', '\u{0308}', '\u{0301}',),
                    0x91 ..= 0xa1  => from.wrapping_add(0x0020),
                    0xa3 ..= 0xab  => from.wrapping_add(0x0020),
                    ...
                    0xf9 => 0x03f2,
                    0xfa => 0x03fb,
                    0xfd ..= 0xff  => from.wrapping_sub(0x0082),
                    _ => from
                }
            }
            0x04 => {
                match low_byte {
                    0x00 ..= 0x0f  => from.wrapping_add(0x0050),
                    0x10 ..= 0x2f  => from.wrapping_add(0x0020),
                    0x60 ..= 0x80  => (from | 1),
                    0x8a ..= 0xbe  => (from | 1),
                    0xc0 => 0x04cf,
                    0xc1 ..= 0xcd  => ((from+1) & !1),
            ...
            0x05 => {
                match low_byte {
                    0x00 ..= 0x2e  => (from | 1),
                    0x31 ..= 0x56  => from.wrapping_add(0x0030),
            ...
            0x10 => {
                match low_byte {
                    0xa0 ..= 0xc5  => from.wrapping_add(0x1c60),
                    0xc7 => 0x2d27,
                    0xcd => 0x2d2d,
                    _ => from
                }
            ...
            0x13 => {
                match low_byte {
                    0xf8 ..= 0xfd  => from.wrapping_sub(0x0008),
                    _ => from
                }
            }
            0x14 => {
            ...
            0x1c => {
                match low_byte {
                    ...
                    0x81 => 0x0434,
                    0x82 => 0x043e,
                    0x83 ..= 0x84  => from.wrapping_sub(0x1842),
                    0x85 => 0x0442,
                    0x86 => 0x044a,
                    0x87 => 0x0463,
                    0x88 => 0xa64b,
                    0x90 ..= 0xba  => from.wrapping_sub(0x0bc0),
                    0xbd ..= 0xbf  => from.wrapping_sub(0x0bc0),
                    _ => from
                }
            }
            0x1d => {
            ...
            0x1f => {
                match low_byte {
                    0x08 ..= 0x0f  => from.wrapping_sub(0x0008),
                    0x18 ..= 0x1d  => from.wrapping_sub(0x0008),
                    0x28 ..= 0x2f  => from.wrapping_sub(0x0008),
                    0x38 ..= 0x3f  => from.wrapping_sub(0x0008),
                    0x48 ..= 0x4d  => from.wrapping_sub(0x0008),
                    ...
                    0x59 ..= 0x5f  => if (from & 1) == 1 { from.wrapping_sub(0x0008) } else { from },
                    0x68 ..= 0x6f  => from.wrapping_sub(0x0008),
                    ...
                    0xb8 ..= 0xb9  => from.wrapping_sub(0x0008),
                    0xba ..= 0xbb  => from.wrapping_sub(0x004a),
                    ...
                    0xc8 ..= 0xcb  => from.wrapping_sub(0x0056),
                    ...
                    0xd8 ..= 0xd9  => from.wrapping_sub(0x0008),
                    0xda ..= 0xdb  => from.wrapping_sub(0x0064),
                    ...
                    0xe8 ..= 0xe9  => from.wrapping_sub(0x0008),
                    0xea ..= 0xeb  => from.wrapping_sub(0x0070),
                    0xec => 0x1fe5,
                    ...
                    0xf8 ..= 0xf9  => from.wrapping_sub(0x0080),
                    0xfa ..= 0xfb  => from.wrapping_sub(0x007e),
            ...
            0x21 => {
                match low_byte {
                    ...
                    0x2b => 0x00e5,
                    0x32 => 0x214e,
                    0x60 ..= 0x6f  => from.wrapping_add(0x0010),
                    0x83 => 0x2184,
                    _ => from
                }
            }
            ...
            0x24 => {
                match low_byte {
                    0xb6 ..= 0xcf  => from.wrapping_add(0x001a),
                    _ => from
                }
            }
            0x25 => {
            ...
            0x2c => {
                match low_byte {
                    0x00 ..= 0x2e  => from.wrapping_add(0x0030),
                    0x60 => 0x2c61,
                    0x62 => 0x026b,
                    0x63 => 0x1d7d,
                    0x64 => 0x027d,
                    ...
                    0x72 => 0x2c73,
                    0x75 => 0x2c76,
                    0x7e ..= 0x7f  => from.wrapping_sub(0x2a3f),
                    0x80 ..= 0xe2  => (from | 1),
                    0xeb ..= 0xed  => ((from+1) & !1),
                    0xf2 => 0x2cf3,
                    _ => from
        ...
        let single_char: u32 = match from {
            0xa640 ..= 0xa66c  => (from | 1),
            0xa680 ..= 0xa69a  => (from | 1),
            0xa722 ..= 0xa72e  => (from | 1),
            0xa732 ..= 0xa76e  => (from | 1),
            0xa779 ..= 0xa77b  => ((from+1) & !1),
            0xa77d => 0x1d79,
            0xa77e ..= 0xa786  => (from | 1),
            0xa78b => 0xa78c,
            0xa78d => 0x0265,
            0xa790 ..= 0xa792  => (from | 1),
            0xa796 ..= 0xa7a8  => (from | 1),
            0xa7aa => 0x0266,
            0xa7ab => 0x025c,
            0xa7ac => 0x0261,
            0xa7ad => 0x026c,
            ...
            0xa7b2 => 0x029d,
            0xa7b3 => 0xab53,
            0xa7b4 ..= 0xa7be  => (from | 1),
            0xa7c2 => 0xa7c3,
            0xa7c4 => 0xa794,
            0xa7c5 => 0x0282,
            0xa7c6 => 0x1d8e,
            0xab70 ..= 0xabbf  => from.wrapping_sub(0x97d0),
            ...
            0xff21 ..= 0xff3a  => from.wrapping_add(0x0020),
            0x10400 ..= 0x10427  => from.wrapping_add(0x0028),
            0x104b0 ..= 0x104d3  => from.wrapping_add(0x0028),
            0x10c80 ..= 0x10cb2  => from.wrapping_add(0x0040),
            0x118a0 ..= 0x118bf  => from.wrapping_add(0x0020),
            0x16e40 ..= 0x16e5f  => from.wrapping_add(0x0020),
            0x1e900 ..= 0x1e921  => from.wrapping_add(0x0022),
            _ => from
        };
...
fn lookup_consistency() {
    ...
    for c_index in 0..126217 {
        if let Some(c) = char::from_u32(c_index) {
            let reference: Vec<char> = lookup_naive(c).collect();            let actual: Vec<char> = lookup(c).collect();            assert_eq!(reference, actual, "case-folding {:?} (#0x{:04x})", c, c_index);
        }
    }
}
